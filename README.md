...
本轮正在适配上述独立打标规则，尚待对既有27篇合格正文中的16篇缺项补处理，预计复用11篇成功结果。旧批次26篇“未分类”的原因是15篇被相关性门禁提前跳过分类、10篇缺正文、1篇Jev分类失败，并非前端漏读；详见[技术诊断与处理边界](docs/architecture/UNIFIED_NEWS_PIPELINE.md#2026-09-23-独立打标调整)。Opus253修正也尚未晋升，将在统一候选中审核发布；此处不提前改变已发布数量或固定后续精选成员。
